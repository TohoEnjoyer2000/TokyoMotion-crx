...
const sep = document.getElementsByClassName("separator m-t-15 p-0")[0]
const src = document.getElementById("vjsplayer_html5_api").childNodes[1].src
...
function run() {
    ...
    downloadBtn.onclick = () => { window.open(`${src}/${id}.mp4`, 'download_window'); return false; }
